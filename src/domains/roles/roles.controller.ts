...
export class RolesController {
  ...
  @Post()
  @Permission(RoleAccess.CREATE_ROLE)
  @ApiBearerAuth()
  ...
  @Get()
  @Permission(RoleAccess.GET_ALL_ROLES)
  ...
  @Get(':id')
  @Permission(RoleAccess.GET_ROLE_BY_ID)
  @ApiBearerAuth()
  ...
  @Patch(':id')
  @Permission(RoleAccess.UPDATE_ROLE)
  @ApiBearerAuth()
  ...
  @Delete(':id')
  @Permission(RoleAccess.DELETE_ROLE)
  @ApiBearerAuth()
