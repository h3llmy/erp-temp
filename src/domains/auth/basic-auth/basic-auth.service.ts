...
export class BasicAuthService {
   ...
   *
   * @param {string} credential - The verification token sent to the user's email.
  ...
  /**
   * Retrieves a user by their email for forget password flow.
   * Throws an error if the user is logged in with social.
   *
   * @param {ForgetPasswordDto} forgetPasswordDto - The forget password dto containing email.
   * @return {Promise<User>} A promise that resolves to the user entity if the email is found and not social user.
   * @throws {BadRequestException} If the user is logged in with social.
